      ...
      <div className="mx-auto w-full md:max-w-[1280px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[45%_55%] gap-8 md:gap-12 items-center justify-items-center md:justify-items-start">
          ...
          <div className="flex flex-col w-full">
            ...
            >
              {c.descricao} Conheça nossos <a href="/produtos" className="text-[#0d70dc] hover:underline font-semibold">produtos e soluções</a> ou saiba mais <a href="/quem-somos" className="text-[#0d70dc] hover:underline font-semibold">sobre a Titaniun Implantes</a>.
            </p>
          </div>
